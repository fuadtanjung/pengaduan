    ...
    <div class="col-lg-12">
        <div class="card no-b">
            <div class="card-body">
                ...
                <button type="button" class="btn btn-primary btn-sm legitRipple" data-toggle="modal" data-target="#input_user">
            ...
            <div id="input_user" class="modal fade">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="form_user" class="form-material">
                                {{ csrf_field() }}
                                <legend class="text-semibold">Data User</legend>
                                <br>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <h6>Singkatan</h6>
                                                <input type="text" class="form-control" id="sk_user" name="sk_user">
                                            </div>
                                        </div>
                                    </div>
                                </div>
